...
<% 
  String loginService = "eeplat_user_findbyemailandpwd";
...
<div align="center" style="margin:7em 7em 0 7em" > <img border=0   src="<%=request.getContextPath()%>/web/default/images/logo_appshare.png"/>
</div>
<br/>
...
<form name="loginform" id="loginform"  method="post">
	<p>
		<label><%=I18n.instance().get("邮箱")%> </label> <br />
  ...
  function submitForm(){
	   ...
	   $.post(globalURL + "ssocontroller",paras,
			function (data){
			   ...
			   if('success'==retValue){
			        window.location= globalURL + "pane_appshare.pml?isApp=true";
			   }else{
