 ...
 * @version  1.0
 */
public class DOMAXIDYearDeptTrash {

	private static DOMAXIDYearDeptTrash builder;
	 ...
	 * @return
	 */
	public static DOMAXIDYearDeptTrash getInstance() {

		if (builder == null) {
			synchronized (lockObj) {
				if (builder == null) {
					builder = new DOMAXIDYearDeptTrash();
				}
			}
		}
		return builder;
