 ...
 * @author aa
 */
public class GridListEdit extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListEdit.class);

	public GridListEdit() {
		dealTemplatePath("/grid/GridListEdit.ftl");
	}
	...
	public static List<BOInstance> getListData(DOGridModel gridModel,
		...
		if(gridModel.getService()==null){
			return new ArrayList<BOInstance>();
		}
