...
<link rel="stylesheet" href="<%=request.getContextPath()%>/web/default/js/jquery-plugin/bootstrap/css/bootstrap.min.css" type="text/css"/>
<link rel="stylesheet" href="<%=request.getContextPath()%>/web/default/js/jquery-plugin/bootstrap/css/bootstrap-responsive.min.css" type="text/css"/>
...
<div class="container">
	...
	<%=paneModelContent%>
	 <div class="row show-grid">
	 	<div class="span7">&nbsp;</div>
		<div class="span2">
			<a href="http://www.eeplat.com"> <img src="<%=request.getContextPath()%>/web/default/images/poweredby_s.jpg" /> </a>
		</div>
	</div>
</div>
</body>
