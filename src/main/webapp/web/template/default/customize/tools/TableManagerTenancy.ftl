...
<div width="100%" height="100%">
	 <div  class="gridTitle" >
		 					...
		 					<img src='/${webmodule}/web/default/images/MyRightArrow.jpg'/> <b> 数据表结构 </b> 
		 ...
		 <#list data as ins>
		   ...
		   <tfoot>
	     	<tr> <td  style="text-align:center;align:center"  colspan="4" >
			           <button  type="button"   style=""  id='3ba35f69a6084e76bfed4c89e41c2f65'  class='ctlBtn btn' >保存</button>
					<script>
