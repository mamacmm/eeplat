...
//				}
	...
	private void initController() {
		...
		gridList = DOController.getControllerByName(GridList.class.getName());
		...
		formTimeC = DOController
				.getControllerByName(DatePicker.class.getName());

		paneC = DOController.getControllerByName(ContentPane.class.getName());

		formSaveButton = DOController.getControllerByName(TService.class
				.getName());

		paneOverFlow = DOController.getControllerByName(ContentPaneScroll.class
				.getName());

		formCloseButton = DOController.getControllerByName(TClose.class
				.getName());
