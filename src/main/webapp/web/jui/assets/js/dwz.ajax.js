...
function dwzPageBreak(options){
	var op = $.extend({ targetType:"navTab", rel:"", data:{pageNum:"",pageNo:"1", numPerPage:"", orderField:"", orderDirection:""}, callback:null}, options);
	...
	if (op.rel) {
		...
		params.push({name:'pageNo',value:op.data.pageNo});
