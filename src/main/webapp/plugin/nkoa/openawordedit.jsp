...
<script type="text/javascript" src="<%=request.getContextPath()%>/web/default/js/jquery/jquery.js"></script>
...
<FORM id="myForm" name="myForm" METHOD="POST"
	ENCTYPE="multipart/form-data" ACTION="../web/default/upload_action.jsp">
