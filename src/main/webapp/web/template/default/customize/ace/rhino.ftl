...
<iframe id="ace_editer_code_rhino" name="ace_editer_code" frameborder='0' src="${requestContextPath}/plugin/ace_editor/rhino.jsp?hiddenid=${model.fullColID}" style="width:100%;height:450px"/>
</#if>
