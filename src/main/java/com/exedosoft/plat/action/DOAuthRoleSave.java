...
public class DOAuthRoleSave extends DOAbstractAction {
	...
	private void appAuth(String parterUid) {

		List allAuthApps = SessionParterFactory.getSessionParter()
				.getApplicationsByRole(parterUid);
		System.out.println("allApp:::" + allAuthApps);

		baseAuth(parterUid, allAuthApps, "appAuth",
				DOAuthorization.WHAT_APPLICATION,null);
