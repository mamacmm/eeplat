  ...
  <%
	...
	if (exedoContext != null && exedoContext.getUser() != null) {
	   ...
	   System.out.println(doaName);
			 ...
			 DOMenuModel dmm = DOMenuModel.getMenuModelByName(doaName +  "_root");
             List parents =  new ArrayList();       
             if(dmm!=null){
			 	parents =  dmm.retrieveChildrenNoAuth();
             }else{
            	 out.println("请修改web/default/DO_Auth_Role.jsp文件233行左右，DOMenuModel.getMenuModelByName()，换成实际的根菜单名称");
             }
