...
public class DOValueImage extends DOBaseForm  implements DOIView {
	...
	public String getHtmlCode(DOIModel aModel) {
		...
		if (property.getValue() != null) {
			...
			if (isPic(property.getValue())
				...
				buffer.append("<img src='").append(aPath);
				if(DOGlobals.getInstance().getServletContext().getRequest().getSession()!=null){
					buffer.append(";jsessionid=").append(DOGlobals.getInstance().getServletContext().getRequest().getSession().getId());
				}
