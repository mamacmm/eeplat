 ...
 * @author aa
 */
public class GridListStyle2 extends DOViewTemplate {

	private static Log log = LogFactory.getLog(GridListStyle2.class);

	public GridListStyle2() {
		dealTemplatePath( "/grid/GridListStyle2.ftl");
	}
