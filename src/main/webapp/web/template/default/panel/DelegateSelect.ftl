...
<link type="text/css" rel="stylesheet" href="web/default/css/delegatepane.css" />
<title>商飞</title>
</head>

<body>
<div class="bg">
<img src="web/default/images/delegate/bg.jpg" style="width:100%; height:100%; z-index:-10000; position:absolute; top:0px;" />
</div>
