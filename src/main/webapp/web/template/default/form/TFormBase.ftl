<#macro JudgeStyle a>
	...
	<#elseif (a.style?exists ) >
		class='${a.style} btn'   <#compress><@JudgeMobileIcon a/> </#compress>
	<#elseif  (a.l10n?exists && (a.l10n?contains('新增') || a.l10n?contains('新建') || a.l10n?contains('创建')
		...
		class='new btn'   <#compress><@JudgeMobileIcon a/> </#compress>
