...
$('#${model.objUid}').bind('click',function(){
	...
	frame.src = globalURL+"web/default/download_action.jsp?formArgs="+para+"&serviceID=<#if model.linkService.objUid?exists>${model.linkService.objUid}<#else>${serviceID}</#if>&fileName="+templateFileName;
