...
<% 
  String loginService = "do_org_account_findbynameAndPassword";
  DOBO versionBO = DOBO.getDOBOByName("versionid");
  if(versionBO!=null){
	  loginService = "do_org_account_findbynameAndPassword_md5"; 
  }
  System.out.println("Console.jsp Referer::" + request.getHeader("Referer"));
%>
...
<div align="center" style="margin:7em 7em 0 7em" > <img border=0   src="<%=request.getContextPath()%>/web/default/images/logo_console.png"/>
</div>
<br/>
...
//回车事件
  ...
  function submitForm(){
	   ...
	   paras = paras + "&contextServiceName=<%=loginService%>";
	   $.post(globalURL + "ssocontroller",paras,
			function (data){
			   ...
			   if('success'==retValue){
			        window.location= "abp_base_pane.pml?isApp=true";
			   }else{
