...
////////////add by weikx at 20070828
var oldSelectName = "";
var treePrefix = globalURL;// + "web/default/";
if(treePrefix.indexOf("/default")==-1){
	treePrefix = globalURL + "web/default/";
}
//
...
var webFXTreeConfig = {
	...
	rootIcon        : treePrefix + 'images/xp/folder.png',
	openRootIcon    : treePrefix + 'images/xp/openfolder.png',
	folderIcon      : treePrefix + 'images/xp/folder.png',
	openFolderIcon  : treePrefix + 'images/xp/openfolder.png',
	fileIcon        : treePrefix + 'images/xp/file.png',
	iIcon           : treePrefix + 'images/xp/I.png',
	lIcon           : treePrefix + 'images/xp/L.png',
	lMinusIcon      : treePrefix + 'images/xp/Lminus.png',
	lPlusIcon       : treePrefix + 'images/xp/Lplus.png',
	tIcon           : treePrefix + 'images/xp/T.png',
	tMinusIcon      : treePrefix + 'images/xp/Tminus.png',
	tPlusIcon       : treePrefix + 'images/xp/Tplus.png',
	blankIcon       : treePrefix + 'images/xp/blank.png',
	iconPath        : treePrefix + '/images/icons/',
...
_p.getIconSrc = function () {
	...
	if (open && this.openIcon) {
	    if(this.openIcon.indexOf('exedo')==-1){
			return webFXTreeConfig.iconPath + this.openIcon;
		}else{
		    return this.openIcon;
		}	
	}
	if (!open && this.icon) {
	    if(this.icon.indexof('exedo')==-1){
			return webFXTreeConfig.iconPath + this.icon;
		}else{
		    return this.icon;
		}	
	}
