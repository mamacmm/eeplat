...
//		
		...
		buffer.append("<div class='input-append'>		<input class='resultlistpopup' type='hidden'   name='").append(
		...
		buffer.append(this.appendValidateConfig(fm,true));
		...
		buffer
				.append(
						"<span class='add-on'>  <img  class='popupimg' onclick=invokeStaticPopup(this")
